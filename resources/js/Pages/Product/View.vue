      ...
      <div
        ...
        <div v-else class=" container mx-auto ">
          ...
          <div class="flex   ">
            ...
            <div class="grow bg-neutral-50 rounded-lg p-2 text-neutral-700">
              ...
              <div class="p-4   w-full flex flex-col items-stretch justify-start items-start items-between">
                ...
                <div class="flex items-center text-sm">
                  ...
                  <div class="flex items-center text-sm ">
                    ...
                    <div class="  text-neutral-700 font-bold mx-1 ">{{ data.in_shop }}</div>
              ...
              <div class="text-neutral-500 p-2 text-sm">{{ data.description }}</div>
            </div>
