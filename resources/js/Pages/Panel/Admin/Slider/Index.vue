    ...
    <template v-slot:content>
      ...
      <div
        ...
        <div class="flex">
          ...
          <h1 class="text-2xl font-semibold">{{ __('slider') }}</h1>
        </div>
        <div>
          <Link :href="route('panel.admin.slider.create')"
        ...
        <div class="flex-col   bg-white  overflow-x-auto shadow-lg  rounded-lg">
          <div class="flex   items-center justify-between py-4 p-4">
            ...
            <div class="relative ">
              ...
              <input type="text" id="table-search-slides" v-model="params.search" @keydown.enter="getData()"
          ...
          <table class="w-full text-sm text-left text-gray-500">
            ...
            <tr class="text-sm text-center">
              ...
              <th scope="col"
                  class="px-2 py-3   cursor-pointer duration-300 hover:text-gray-500 hover:scale-[105%]"
                  @click="params.order_by='is_active';params.dir=params.dir=='ASC'? 'DESC':'ASC'; params.page=1;getData()">
                <div class="flex items-center justify-center">
            ...
            <tr v-for="(d,idx) in data"
              ...
              <td
                  class="flex  items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                <Image class="w-10 h-10 rounded-full cursor-pointer" :src="`${route('storage.slides')}/${d.id}.jpg`"
                       :alt="cropText(d.title,5)" :data-lity="`${route('storage.slides')}/${d.id}.jpg`"/>
                <Link class="px-3 hover:text-gray-500" :href="route('panel.admin.slider.edit',d.id)">
                  <div class="text-base text-sm font-semibold">{{ cropText(d.title, 30) }}</div>
                  <div class="font-normal text-gray-500">{{ }}</div>
                </Link>
              </td>
              ...
              <td class="px-2 py-4    " data-te-dropdown-ref>
                ...
                <ul ref="statusMenu" data-te-dropdown-menu-ref
                  ...
                  <li v-if="d.is_active " role="menuitem"
              ...
              <td class="px-2 py-4">
                ...
                <div
                    ...
                    role="group">
                  <Link
                      type="button" :href="route('panel.admin.slider.edit',d.id)"
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.loading = true;
      this.data = [];
      window.axios.get(route('panel.admin.slider.search'), {
        params: this.params
      }, {})
          .then((response) => {
    ...
    edit(params) {
      this.isLoading(true);
      window.axios.patch(route('panel.admin.slider.update'), params,
          {})
          .then((response) => {
            ...
            if (response.data.wallet) {
              ...
              this.slider.wallet = response.data.wallet;
            }
