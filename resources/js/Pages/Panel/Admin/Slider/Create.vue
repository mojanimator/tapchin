  ...
  <Panel>
    ...
    <template v-slot:content>
      ...
      <div
        ...
        <h1 class="text-2xl font-semibold">{{ __('create_slider_item') }}</h1>
            ...
            <form @submit.prevent="submit">
              ...
              <div class="my-2  ">
                <ImageUploader :replace="true"
                               mode="create"
                               ref="imageCropper" :label="__('image_cover_jpg')" :cropRatio="$page.props.sliderRatio"
                               id="img"
                               classes="grow h-64   "/>
              ...
              <div class="flex items-center">
                ...
                <RadioGroup v-model="form.status" ref="roleSelector" class="grow"
                            name="role"
...
export default {
  ...
  methods: {
    submit() {
      ...
      // this.status = this.$refs.roleSelector.selected;
      ...
      this.form.post(route('panel.admin.slider.create'), {
          ...
          if (!this.form.uploading) {
            ...
            this.form.transform((data) => ({
              ...
              img: this.img,
                ...
                .post(route('panel.admin.slider.create'), {
                  preserveScroll: false,
                  onSuccess: (data) => {
