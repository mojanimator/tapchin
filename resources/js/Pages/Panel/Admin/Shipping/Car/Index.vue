    ...
    <template v-slot:content>
      ...
      <div
        ...
        <div class="flex">
          ...
          <h5 class="  font-semibold">{{ __('cars_list') }}</h5>
        </div>
        <div>
          <Link :href="route('admin.panel.shipping.car.create')"
          ...
          <div class="     w-full overflow-x-auto   md:rounded-lg">
            <table ref="tableRef "
              ...
              <tr class="text-sm text-center ">
                ...
                <th scope="col"
                    class="px-2 py-3   cursor-pointer duration-300 hover:text-gray-500 hover:scale-[99%]"
                    @click="params.order_by='plate_number';params.dir=params.dir=='ASC'? 'DESC':'ASC'; params.page=1;getData()">
                  <div class="flex items-center justify-center">
                    <span class="px-2">    {{ __('plate_number') }} </span>
                    <ArrowsUpDownIcon class="w-4 h-4 "/>
                  </div>
                </th>
              ...
              <tr v-for="(d,idx) in data"
                ...
                <td
                  ...
                  <Image class="w-10 h-10 cursor-pointer rounded-full"
                         :src="`${route('storage.cars')}/${d.id}.jpg`"
                ...
                <td class="px-2 py-4    ">
                  {{ d.agency ? `${d.agency.name} (${d.agency.id})` : '' }}
                </td>
                ...
                <td class="px-2 py-4">
                  ...
                  <div
                      ...
                      role="group">
                    <Link
                        type="button" :href="route('admin.panel.shipping.car.edit',d.id)"
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.loading = true;
      this.data = [];
      window.axios.get(route('admin.panel.shipping.car.search'), {
        params: this.params
      }, {})
          .then((response) => {
