    ...
    <template v-slot:content>
      ...
      <div
        ...
        <div class="flex">
          ...
          <h5 class="  font-semibold">{{ __('drivers_list') }}</h5>
        </div>
        <div>
          <Link :href="route('admin.panel.shipping.driver.create')"
              ...
              <tr v-for="(d,idx) in data"
                ...
                <td class="px-2 py-4">
                  ...
                  <div
                      ...
                      role="group">
                    <Link
                        type="button" :href="route('admin.panel.shipping.driver.edit',d.id)"
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.loading = true;
      this.data = [];
      window.axios.get(route('admin.panel.shipping.driver.search'), {
        params: this.params
      }, {})
          .then((response) => {
