  ...
  <Panel>
    ...
    <template v-slot:content>
      ...
      <div
        ...
        <h1 class="text-2xl font-semibold">{{ __('edit_driver') }}</h1>
            ...
            <div class="flex-col   m-2 items-center rounded-lg max-w-xs  w-full mx-auto    ">
              <div class="my-2">
                <ImageUploader :replace="true"
                               :preload="route('storage.drivers')+`/${$page.props.data.id}.jpg`"
                               mode="edit" :for-id="$page.props.data.id"
                               :link="route('admin.panel.shipping.driver.update')"
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      // }
      this.form.patch(route('admin.panel.shipping.driver.update'), {
