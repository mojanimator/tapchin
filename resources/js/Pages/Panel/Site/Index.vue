              ...
              <div class="relative mx-1  " data-te-dropdown-ref>
                ...
                <div ref="actionsMenu" data-te-dropdown-menu-ref
                  ...
                  <li role="menuitem" @click="bulkAction('bulk.start-view')"
                      class=" cursor-pointer  block  p-4 text-sm text-success-700 transition-colors hover:bg-gray-100">
                  ...
                  <li role="menuitem" @click="bulkAction('bulk.stop-view')"
                      class=" cursor-pointer   block  p-4 text-sm text-danger-700 transition-colors hover:bg-gray-100">
                    <div class="flex items-center  px-6   justify-between ">
            ...
            <tr v-for="(d,idx) in data"
              ...
              <td class="px-2 py-4    " data-te-dropdown-ref>
                ...
                <ul ref="statusMenu" data-te-dropdown-menu-ref
                  ...
                  <!--                      class="   cursor-pointer   text-sm text-blue-500 transition-colors hover:bg-gray-100">-->
                  ...
                  <li v-if="d.status=='view'" role="menuitem"
                      ...
                      class="   cursor-pointer   text-sm text-red-700 transition-colors hover:bg-gray-100">
                    <div class="flex items-center  px-6 py-2 justify-between ">
                      <span class="bg-danger mx-1  animate-pulse px-1 py-1 rounded "></span>
                      {{ __('stop_view') }}
                    </div>
                  ...
                  <li v-if="d.status=='ready'  " role="menuitem"
                      @click="edit({'idx':idx,'id':d.id,'cmnd':'start-view'})"
