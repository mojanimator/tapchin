    ...
    <template v-slot:content>
      ...
      <div
        ...
        <div class="flex">
          ...
          <h1 class="text-2xl font-semibold">{{ __('videos_list') }}</h1>
        </div>
        <div>
          <Link :href="route('panel.video.create')"
        ...
        <div class="flex-col   bg-white  overflow-x-auto shadow-lg  rounded-lg">
          ...
          <table class="w-full text-sm text-left text-gray-500">
            ...
            <tr v-for="(d,idx) in data"
              ...
              <td
                  class="flex  items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                <Image class="w-10 h-10 rounded-full" :src="`${route('storage.videos')}/${d.id}.jpg`"
                       :alt="cropText(d.name,5)"/>
                <Link class="px-3 hover:text-gray-500" :href="route('panel.video.edit',d.id)">
              ...
              <td class="px-2 py-4">
                ...
                <div
                    ...
                    role="group">
                  <Link
                      type="button" :href="route('panel.video.edit',d.id)"
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.loading = true;
      this.data = [];
      window.axios.get(route('panel.video.search'), {
        params: this.params
      }, {
    ...
    edit(params) {
      this.isLoading(true);
      window.axios.patch(route('video.update'), params,
          {
            onUploadProgress: function (axiosProgressEvent) {
              // console.log(axiosProgressEvent);
              /*{
